...
get_input <- function(age0 = 40,
  ...
  input$exacerbation$logit_severity_betas = t(as.matrix(c(intercept1 = -3, intercept2 = 1.5, intercept3 = 5.208, female = 0, age = -0.007,
  ...
  input_help$diagnosis$max_cd_age <- "Maximum age for recieving case detection"
  input$diagnosis$max_cd_age <- 111
  input_ref$diagnosis$max_cd_age <- "Default is 111 which is the maximmum age in EPIC i.e. no upper age limit to case detection."
