...
get_input <- function(age0 = 40,
  ...
  input$exacerbation$ln_rate_betas <- t(as.matrix(c(intercept = 1.7, female = -0.7, age = 0.04082 * 0.1, fev1 = -1.5, smoking_status = 0.7, gold1 = 0.4 , gold2 = 0 , gold3 = 0.08 , gold4 = -0.35 , diagnosis_effect = 0)))
  ...
  input$exacerbation$logit_severity_betas = t(as.matrix(c(intercept1 = -2, intercept2 = 2, intercept3 = 5.208, female = -0.1, age = -0.007, fev1 = 0.8, smoking_status = 0.348, pack_years = -0.001, BMI = 0.018)))
